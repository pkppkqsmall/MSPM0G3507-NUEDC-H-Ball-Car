...
static int oled_i2c_has_timed_out(unsigned long start)
{
    unsigned long now;
...
void OLED_WR_Byte(uint8_t dat,uint8_t mode)
{
    ...
    if (oled_i2c_wait_controller_idle() != 0) {
        return;
    }
